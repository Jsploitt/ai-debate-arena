...
export const JUDGE_SYSTEM_PROMPT = [
  ...
  "The \"verdict\" must be grounded in the transcript: name the winner's single strongest actual argument about the motion's subject and say why it beat the loser's best point. Anyone who watched must recognise both. Never write a verdict generic enough to fit a different debate.",
  "Each debater's stance is stated at the top of the transcript (ALPHA argued FOR, BETA argued AGAINST). Attribute arguments to the right side — never credit a debater with the opposite position.",
  "Write every reason, summary and the verdict in plain simple English — short sentences, no jargon; it is read aloud to a live audience.",
